 ...
 * @author lenovo
 */
@WebServlet(name = "EditSort", urlPatterns = {"/EditSort"})
public class EditSort extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            */
            String update="INSERT INTO `myblog`.`sortof" +user.username+"` (`sortName`, `number`) VALUES ('"+request.getParameter("editsort")+"', '0');";
